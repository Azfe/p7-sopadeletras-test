...
<html>
  <head>
    ...
    <title>Página de login: Sopa de Letras</title>
    <style type="text/css">
.box {
  width: 450px; 
  margin-top: 20%; 
...
.colc {
  ...
  <body>
    <div align="center" class="box">
      ...
      <tr>
		<button onclick="location.href='juego'">Jugar</button>
		<button onclick="location.href='partidas.jsp'">Ver partidas</button>
	  </tr>
    </div>
  </body>
</html>
