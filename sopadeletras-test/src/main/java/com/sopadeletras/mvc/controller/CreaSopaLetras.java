...
public class CreaSopaLetras {
	...
	SopadeLetra sopa = new SopadeLetra(dimen, dimen, texto);
    ...
    private String[] cogerPalabras() throws SQLException{
    	...
    	EntityManagerFactory emfactory = Persistence.createEntityManagerFactory( "AlexZapata");
        ...
        for(int i = 0; i < nPalabras; i++) {
        	...
        	strings[i]=normalizeString(palabra.getNomPalabra().toUpperCase());
        }
